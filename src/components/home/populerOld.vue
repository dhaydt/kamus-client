...
export default {
	data() {
		return {
			urlPopKbbi: "http://localhost:3002/kamus/pop",
			urlPopIstilah: "http://localhost:3002/istilah/pop",
			urlPopNama: "http://localhost:3002/nama/pop",
			urlPopEngIn: "http://localhost:3002/engin/pop",
			urlPopInEng: "http://localhost:3002/ineng/pop",
			popKbbi: [],
			popIstilah: [],
			popNama: [],
			popEngIn: [],
