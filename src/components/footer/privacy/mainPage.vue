	...
	<div class="box-detail">
		<div class="box-slice">
			<div class="box-detail-single">
				...
				<p>
					Privacy Policy - If you require any more information or have any
					questions about our privacy policy, please feel free to contact us by
					comment.
				</p>

				<p>
					At kamuskbbi.id, the privacy of our visitors is of extreme importance
					to us. This privacy policy document outlines the types of personal
					information is received and collected by kamuskbbi.id and how it is
					used.
				</p>
				<p class="mb-1">Log Files</p>
				<p>
					Like many other Web sites, kamuskbbi.id makes use of log files. The
				...
				<p class="mb-1">Cookies and Web Beacons</p>
				<p class="mb-1">kamuskbbi.id does not use cookies.</p>
				<br />
				<br />
				<p class="mb-1">DoubleClick DART Cookie</p>
				<p class="mb-1">
				...
				<p class="mb-1">
					...
					based on their visit to kamuskbbi.id and other sites on the Internet.
				</p>
				<p>
				...
				<p>
					...
					advertisements and links that appear on kamuskbbi.id send directly to
				...
				<p>
					kamuskbbi.id has no access to or control over these cookies that are
				...
				<p>
					...
					practices. kamuskbbi.id's privacy policy does not apply to, and we
